...
<head>
    ...
    <title>Sin Bono Disponible</title>
    <link rel="stylesheet" href="/pract3/css/stylesUser.css">
</head>
<body>
    <div class="container">
        <h1>Sin bono disponible</h1>
        <p>No tienes un bono válido para el tipo de reserva seleccionado. Por favor, adquiere un bono compatible.</p>
