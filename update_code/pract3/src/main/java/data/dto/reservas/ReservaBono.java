...
/**
 * La clase {@code ReservaBono} es una implementación de {@code ReservaCreator}
 * que permite crear reservas para diferentes tipos de usuarios (infantil, familiar
 * y adultos) utilizando un bono.
 */
public class ReservaBono extends ReservaCreator{
    
	 /**
     * Crea una reserva infantil utilizando un bono con los parámetros proporcionados.
     *
    ...
    /**
     * Crea una reserva familiar utilizando un bono con los parámetros proporcionados.
     *
     * @param id_user El identificador del usuario que realiza la reserva.
     * @param fecha_hora La fecha y hora en que se realiza la reserva.
     * @param duracion La duración de la reserva en minutos.
    ...
    /**
     * Crea una reserva de adultos utilizando un bono con los parámetros proporcionados.
     *
     * @param id_user El identificador del usuario que realiza la reserva.
     * @param fecha_hora La fecha y hora en que se realiza la reserva.
     * @param duracion La duración de la reserva en minutos.
