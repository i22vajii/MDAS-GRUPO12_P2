...
<%
    if(request.getAttribute("pistas") == null || request.getAttribute("id_bono") == null || request.getAttribute("n_ninos") == null || request.getAttribute("n_adultos") == null || request.getAttribute("duracion") == null || request.getAttribute("fechaHora") == null){
...
<body>
    ...
    <%
        ...
        int id_bono = (Integer) request.getAttribute("id_bono");
    ...
    <form action="/pract3/user/RealizarReservaBonoServlet" method="post">
        ...
        <input type="hidden" name="id_bono" value="<%= id_bono %>">
